  ...
  return (
    <div className="col-span-3 h-full w-full overflow-y-scroll bg-[#fff]/40">
      <div className="flex flex-row items-center justify-center gap-4 py-4">
        <div className="flex flex-row items-center gap-1 border-b-[3px] border-[#5522df] py-0.5 px-1 font-semibold text-[#5522df]">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <div className="flex flex-row items-center gap-1 border-b-[3px] border-[#d9d9d9] py-0.5 px-1 font-semibold text-[#404040]">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
